...
const RoomBooking = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h1 className="text-3xl font-bold mb-6">Book Your Room</h1>
      {error && (
        ...
        <div>
          ...
          <div className="mt-2">
            <label className="inline-flex items-center">
              ...
              />
              <span className="ml-2">Breakfast ($10 per person per night)</span>
            </label>
      ...
      {totalCost > 0 && (
        <div className="mt-4">
          <p className="text-lg font-medium">Total Cost: ${totalCost}</p>
        </div>
      )}
      {isPopupOpen && (
