  ...
  return (
    <div className="ml-64">
      <div className="relative h-screen">
        ...
        <div className="relative bg-[url('https://images.pexels.com/photos/6238614/pexels-photo-6238614.jpeg')] bg-cover bg-center py-12">
          <div className="absolute inset-0 bg-black/30"></div>
          <div className="relative z-10 max-w-4xl mx-auto p-6">
            <div className="bg-white/70 backdrop-blur-sm p-8 rounded-2xl shadow-xl space-y-6 border border-white/20 w-full">
                    ...
                    <div className="space-y-3">
                      <label className="flex items-center space-x-3 bg-gray-50 p-3 rounded-lg hover:bg-gray-100 transition-colors duration-200 cursor-pointer">
                        ...
                        <span className="text-gray-700">
                          Breakfast (Rs. {servicePrices.breakfast} adult per
                          night)
                        </span>
                      </label>
                      <label className="flex items-center space-x-3 bg-gray-50 p-3 rounded-lg hover:bg-gray-100 transition-colors duration-200 cursor-pointer">
                        ...
                        <span className="text-gray-700">
                          Airport Transfer (Rs. {servicePrices.airportTransfer}{" "}
                          per booking)
                        </span>
                      </label>
                      <label className="flex items-center space-x-3 bg-gray-50 p-3 rounded-lg hover:bg-gray-100 transition-colors duration-200 cursor-pointer">
