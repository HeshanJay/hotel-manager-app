      ...
      <div className="max-w-4xl mx-auto p-6 bg-gray-50 min-h-screen">
        ...
        {isPopupOpen && (
          <div 
            ...
            className="fixed inset-0 rounded-2xl bg-black/90 bg-opacity-10 flex justify-center items-center z-50"
          >
            <div className="bg-white p-8 rounded-xl shadow-2xl max-w-md w-full">
              ...
              <div className="space-y-2 text-gray-700">
                ...
                <p>
                  <strong>Date:</strong> {formatDate(formData.eventDate)}
                </p>
                <p>
